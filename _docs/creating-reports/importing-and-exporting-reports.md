...
If you want to send a report to someone, select the Export Report function, choose the report name from the drop-down list in the dialog that appears, and click the *Export Report* button. This downloads the SFX file for that report to your system. You can then email it to someone else, for example. You can also use the *Export All Reports* button to download a zip archive containing all the reports that you have access to.

![](/assets/images/exportareport.png)
...
![](/assets/images/importareport.png)
