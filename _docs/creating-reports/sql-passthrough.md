...
If you need to specify any parameters for the SQL statement, use a **?** as the placeholder for the value. You can then specify a data type, caption, and value for the parameter in a list below the SQL statement. Any parameters you enter here will be used to create filter conditions in the resulting report that's created. 
